...
public class PrimeTester extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // in the PrimeTester class, and set the result field to be the appropriate message.
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if ((event.getAction() == KeyEvent.ACTION_DOWN) && (keyCode == KeyEvent.KEYCODE_ENTER)) {
                    ...
                    try {
                        ...
                        result = PrimeTestCode.isPrime(value) ? primeString : notPrimeString;
